  ...
  constructor(props) {
    ...
    this.button = (
      <DisplayButton
        ...
        value={`Button.dl`}
        content={temp_button(this.props.state, this.inputString)}
    ...
    if (this.props.state.outputType === "temp_button") {
      ...
      this.outputHeader =
        "Here is your button! Click to download or copy the source code directly.";
    } else {
      this.strOutput = temp_form(this.props.state, this.inputString);
      this.outputHeader =
        "Here are your generated components. Click each button to download the source .js";
    }
